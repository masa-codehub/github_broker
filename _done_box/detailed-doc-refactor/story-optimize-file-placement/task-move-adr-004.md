...
## As-is (現状)
- DIコンテナ(punq)の採用を決定した`ADR-004`が、`reqs/adr/`に配置されている。

## To-be (あるべき姿)
- `reqs/adr/004-punq-di-pattern.md`が、`reqs/adr/`配下に移動されている。
...
=======
1. `git mv docs/adr/004-punq-di-pattern.md reqs/adr/004-punq-di-pattern.md` を実行する。
>>>>>>> 1513999 (feat(plan): Refine plan to eliminate document content duplication)
=======
1. `git mv reqs/adr/004-punq-di-pattern.md reqs/adr/004-punq-di-pattern.md` を実行する。
