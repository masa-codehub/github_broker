...
## As-is (現状)
- エージェントの役割設定について決定した`ADR-013`が、`reqs/adr/`に配置されている。

## To-be (あるべき姿)
- `reqs/adr/013-agent-role-configuration.md`が、`reqs/adr/`配下に移動されている。
...
=======
1. `git mv docs/adr/013-agent-role-configuration.md reqs/adr/013-agent-role-configuration.md` を実行する。
>>>>>>> 1513999 (feat(plan): Refine plan to eliminate document content duplication)
=======
1. `git mv reqs/adr/013-agent-role-configuration.md reqs/adr/013-agent-role-configuration.md` を実行する。
