...
## As-is (現状)
- CI/CDプロセスの改善を決定した`ADR-010`が、`reqs/adr/`に配置されている。

## To-be (あるべき姿)
- `reqs/adr/010-ci-cd-process-improvement.md`が、`reqs/adr/`配下に移動されている。
...
=======
1. `git mv reqs/adr/010-ci-cd-process-improvement.md reqs/adr/010-ci-cd-process-improvement.md` を実行する。
