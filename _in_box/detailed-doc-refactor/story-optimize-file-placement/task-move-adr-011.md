...
## As-is (現状)
- 全ブランチでのCIトリガーを決定した`ADR-011`が、`reqs/adr/`に配置されている。

## To-be (あるべき姿)
- `reqs/adr/011-trigger-ci-on-all-branches.md`が、`reqs/adr/`配下に移動されている。
...
=======
1. `git mv docs/adr/011-trigger-ci-on-all-branches.md reqs/adr/011-trigger-ci-on-all-branches.md` を実行する。
>>>>>>> 1513999 (feat(plan): Refine plan to eliminate document content duplication)
=======
1. `git mv reqs/adr/011-trigger-ci-on-all-branches.md reqs/adr/011-trigger-ci-on-all-branches.md` を実行する。
