...
## As-is (現状)
- Geminiモデルの更新とレビューIssueのハンドリングについて記述した`DesignDoc-001`が、`docs/design-docs/`に配置されている。

## To-be (あるべき姿)
- `docs/design-docs/001-update-gemini-model-and-review-issue-handling.md`が、`reqs/design-docs/`配下に移動されている。
