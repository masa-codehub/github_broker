...
def task_service_components():
    ...
    task_service = TaskService(
        ...
        gemini_executor=mock_gemini_executor,
        repo_name=repo_name
    )
    return task_service, mock_github_client, mock_redis_client, mock_gemini_executor, repo_name

def test_request_task_success_first_task(task_service_components):
    task_service, mock_github_client, mock_redis_client, _, repo_name = task_service_components
...
def test_request_task_lock_fails(task_service_components):
    ...
    with pytest.raises(LockAcquisitionError, match="Failed to acquire lock. Server is busy."):
